            ...
            <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-stone-100">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="inline-flex items-center justify-center p-3 bg-luxury-champagne-600 text-white rounded-full shadow-lg hover:bg-luxury-champagne-700 transition-colors group-hover:shadow-luxury"
                    >
                        <ShoppingBag size={18} />
                    </motion.button>
                </div>
